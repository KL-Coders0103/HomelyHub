  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const propertyData = {
        ...
        houseRules: formData.houseRules ? [formData.houseRules] : [],
        images: images
      };
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center mb-8">
          ...
          <div>
            ...
            <p className="text-gray-600">Share your space with travelers worldwide</p>
          </div>
        </div>
            ...
            {step === 1 && (
              ...
              >
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                    ...
                    <p className="text-xs text-gray-500 mt-2">
                      Supported formats: JPEG, PNG, WebP, AVIF, GIF, SVG • Max 10MB each
                    </p>
                  </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mb-3">
                    Describe your place to attract guests
                  </p>
                  <textarea
                    name="description"
            ...
            {step === 3 && (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mb-3">
                    Additional rules and information for guests
                  </p>
                  <textarea
                    name="houseRules"
                    ...
                    rows={4}
                    className="input-field resize-none"
                    placeholder="Check-in instructions, special rules, nearby attractions..."
                  />
                </div>
